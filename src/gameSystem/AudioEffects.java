...
public class AudioEffects {
    ...
    //GAME AUDIOCLIP
    public static AudioClip frogJump = new AudioClip(Main.AUDIO_PATH + "jump.wav");
    public static AudioClip frogDie = new AudioClip(Main.AUDIO_PATH + "frog_die.ogg");
    public static AudioClip frogGoal = new AudioClip(Main.AUDIO_PATH + "goal.ogg");
    public static AudioClip levelGoal = new AudioClip(Main.AUDIO_PATH + "level_goal.ogg");
    public static AudioClip bonus = new AudioClip(Main.AUDIO_PATH + "bonus.ogg");

    //WATER EFFECTS
    public static AudioClip splash= new AudioClip(Main.AUDIO_PATH + "splash.ogg");
    public static AudioClip waterSplash= new AudioClip(Main.AUDIO_PATH + "water-splash.ogg");

    //ROAD EFFECTS
    public static AudioClip siren = new AudioClip(Main.AUDIO_PATH + "siren.ogg");
    public static AudioClip carPass = new AudioClip(Main.AUDIO_PATH + "car-pass.ogg");
    public static AudioClip horn = new AudioClip(Main.AUDIO_PATH + "long-horn.ogg");
